...
const Board = () => {
    ...
    const { buttons, play, playable, rotate, rotate2, hideBall, showItemBall, winnerNumber, gain, animation, winnerEffect, isTxLoading } = useContext(MyContext)
    let boardItems = []
